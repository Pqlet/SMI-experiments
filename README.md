...
This repository builds upon the [VanessB/Information-v3](https://github.com/VanessB/Information-v3) repository and its mutinfo library, thus you should install it beforehand. If you have some issues with installation, try installing from the fork [Pqlet/Information-v3](https://github.com/Pqlet/Information-v3.git).
